    ...
    <section className="relative bg-[#0a0e1a] border-y border-white/[0.07] overflow-hidden py-24 sm:py-32 lg:py-40">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-10 lg:px-14">
        ...
        >
          ...
          {/* Line 4 */}
          <p className="text-[clamp(1.5rem,3vw,2.6rem)] font-light leading-[1.2] tracking-tight text-white/35 mt-4 max-w-3xl">
            That&apos;s why our vision is to make things better — and more precise.
          </p>
        </motion.div>
