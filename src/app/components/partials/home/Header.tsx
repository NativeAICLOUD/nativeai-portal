      ...
      <div className="relative max-w-9xl mx-auto w-full flex justify-between text-left text-[#2A3A4A] mt-36">
        <div className="group">
          ...
          <div className="flex justify-start gap-5">
            ...
            <Link href={Constants.PAGES.ACCELERATE_AZURE} className={`${button({ size: 'lg', color: 'secondary', icon: 'sm' })}`}>
              <svg className={`icon-arrow-right text-black`} width={30} height={20}>
        ...
        <Image src={AzureHeroIMG} alt="Azure Hero" />
      </div>
    </main>
  );
}
