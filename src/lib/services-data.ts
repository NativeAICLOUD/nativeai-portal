...
export const services: Record<string, ServiceData> = {
  "custom-development": {
    ...
    heroHeadline: "We build products that don't break.",
    heroBody: "From MVPs to full-scale platforms — reliable software that grows with your business. Fast to launch, easy to scale, built to last.",
